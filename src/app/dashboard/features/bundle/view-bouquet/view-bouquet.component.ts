...
@Component({
  ...
  styleUrl: './view-bouquet.component.scss'
})
export class ViewBouquetComponent implements OnInit, AfterViewInit {
  id: number;
...
ngOnInit(): void {
  this.bouquetService.getBouquet<BouquetDetail>(this.id).subscribe(bouquet => {
