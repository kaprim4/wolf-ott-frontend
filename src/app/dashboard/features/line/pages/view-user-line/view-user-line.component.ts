...
constructor(
  ...
  this.id = this.activeRouter.snapshot.paramMap.get('id') as unknown as number;
...
ngOnInit(): void {
    this.lineService.getLine<LineDetail>(this.id).subscribe(line => {
      ...
      this.addForm = this.fb.group({
        ...
        owner: [{id: line.memberId }, Validators.required],
        package: [{id: line.packageId}, Validators.required],
